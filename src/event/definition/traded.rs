...
pub struct TradedEventPayload {
    ...
    // pool state
    #[serde(rename = "osp", serialize_with = "serialize_u128")]
    pub old_sqrt_price: u128,
    #[serde(rename = "nsp", serialize_with = "serialize_u128")]
    pub new_sqrt_price: u128,
    #[serde(rename = "octi")]
    pub old_current_tick_index: i32,
    #[serde(rename = "ncti")]
    pub new_current_tick_index: i32,
    #[serde(rename = "odp", serialize_with = "serialize_decimal_price")]
    pub old_decimal_price: DecimalPrice,
    #[serde(rename = "ndp", serialize_with = "serialize_decimal_price")]
