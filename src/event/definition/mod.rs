...
use super::serde::{serialize_option_u64, serialize_u64};
...
pub struct TransferInfo {
    ...
    #[serde(rename = "a", serialize_with = "serialize_u64")]
    pub amount: u64,

    #[serde(rename = "d")]
    pub decimals: Decimals,

    #[serde(rename = "tfb", skip_serializing_if = "Option::is_none")]
    pub transfer_fee_bps: Option<u16>,
    #[serde(
        rename = "tfm",
        skip_serializing_if = "Option::is_none",
        serialize_with = "serialize_option_u64"
    )]
